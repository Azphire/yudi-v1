...
class SubUi_one(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_1.setText(_translate("Dialog", "初涉江湖"))
        self.label_2.setText(_translate("Dialog", "逐句跟背模式"))

# class subWindow_one(QtWidgets.QDialog):

#     def __init__(self):
#         super(subWindow_one, self).__init__()
#         self.ui = SubUi_one()
#         self.ui.setupUi(self)

# app = QtWidgets.QApplication([])
# application = subWindow_one()
# application.show()
# sys.exit(app.exec())
