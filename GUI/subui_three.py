...
class SubUi_three(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_1.setText(_translate("Dialog", "题王争霸"))
        self.label_2.setText(_translate("Dialog", "抽题回答模式"))

# class subWindow_three(QtWidgets.QDialog):

#     def __init__(self):
#         super(subWindow_three, self).__init__()
#         self.ui = SubUi_three()
#         self.ui.init_ui(self)
# app = QtWidgets.QApplication([])
# application = subWindow_three()
# application.show()
# sys.exit(app.exec())
